$('body').append(`<div class="image image-light ">
    ...
    <svg class="section_ml" viewBox="0 0 67 90" preserveAspectRatio="none">
        <path fill="var(--mid_highlight)"
    ...
    <svg class="section_mm" viewBox="0 0 100 90">
        <path fill="var(--mid_highlight)"
    ...
    <svg class="section_mr" viewBox="0 0 32 90" preserveAspectRatio="none">
        <polygon fill="var(--mid_highlight)"
            points="31.99 37.99 30.07 38.89 22.17 37.09 14.15 34.87 6.14 38.34 -0.01 40.2 -0.01 62.08 31.99 62.08 31.99 37.99" />
        <polygon fill="var(--mid_shadow)"
            points="31.99 38.54 30.07 38.89 22.53 37.32 15.6 35.44 6.6 39.38 -0.01 40.59 -0.01 68.38 31.99 68.38 31.99 38.54" />
    </svg>

    <svg class="section_mfog screen" preserveAspectRatio="none">
        <rect class="screen fog" width="100%" height="100%" />
    </svg>

    <svg class="section_fl" viewBox="0 0 67 90" preserveAspectRatio="none">
        <path fill="var(--fore_highlight)"
    ...
    <svg class="section_fm" viewBox="0 0 100 90">
        <path fill="var(--fore_highlight)"
    ...
    <svg class="section_fr" viewBox="0 0 32 90" preserveAspectRatio="none">
        <path fill="var(--fore_highlight)" d="M32,65.55V58.19S12.13,55.08,7.43,56.25A25.56,25.56,0,0,1,0,56.77v8.78Z" />
        <path fill="var(--fore_shadow)" d="M32,61S11.83,55.53,7.13,56.7A24.25,24.25,0,0,1,0,57.29V90H32Z" />
    </svg>

    <svg class="section_ffog screen" preserveAspectRatio="none">
        <rect class="screen fog" width="100%" height="100%" />
    </svg>

    <svg class="section_trees" viewBox="0 0 200 40" preserveAspectRatio="xMidYMax slice">
        <path id="trees" fill="var(--trees)"
    ...
    <audio loop id="MorningAudio">
        <source src="../music/morning.mp3" type="audio/mpeg">
    </audio>

    <audio loop id="NightAudio">
        <source src="../music/night.mp3" type="audio/mpeg">
    </audio>


    <button role="switch" aria-checked="false" id="toggleDark" class="switch">
        <span>🌙</span>
        <span>☀️</span>
    </button>
    ...
    <div class="gamebaby">
        <div class="row">
            <div class="col-md-8 col-sm-12">
                <div id="touxiang" name=img value="01">
  <!-- 旁白 -->
...
<!-- 旁白尾 -->
                    <div class="top-playerimg d-flex">
                    </div>
  ...
  <!-- 人類 -->
                        <div class=" " style=" background-color: #253641; margin:auto;width:90%;  height: 290px;">
                            <div class="container">
                                <div class="row">&nbsp;</div>
                                <div class="row">
                                    <div class="col-4"><input type="text" id="PeopleuserInput" value="人類"
                                            readonly="readonly"
            ...
            <div class="col-md-4 col-sm-12 rightcontent">
                <div class="d-flex" style="margin-top: 4%; margin-bottom:7%" id="describe">
                    <div id="depict" data-toggle="tooltip" data-placement="right" v-bind:title="items.description">
                        <h1 class="Character" id="CharacterId">{{items.name}}</h1>
                ...
                <div class="dialogue" style="background-color: transparent;">
                    <input type="hidden" value="黑夜" id="Day" style="background-color: transparent; border-style: none;"
                        readonly="readonly">
 ...
 <!-- 特殊 -->
    ...
    <!--郎 -->
                ...
                <div class="leave">
                    <button class="glow-on-hover" id="leave" type="button" style="margin-left:80%;margin-top: 10%;"
                        onclick="">離開</button>
                </div>
            </div>
        </div>
